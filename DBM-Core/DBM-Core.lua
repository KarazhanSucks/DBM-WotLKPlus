...
DBM = {
	Revision = parseCurseDate("20220909204229"),
	DisplayVersion = "9.2.23 alpha", -- the string that is shown as version
	ReleaseRevision = releaseDate(2022 ,09 ,09) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}

...
local timerWither		= mod:NewTargetTimer(10, 76043, nil, "Healer", 2, 5, nil, DBM_COMMON_L.HEALER_ICON..DBM_COMMON_L.MAGIC_ICON)
local timerWitherCD		= mod:NewCDTimer(18, 76043, nil, nil, nil, 3, nil, DBM_COMMON_L.MAGIC_ICON)
local timerConsume		= mod:NewTargetTimer(4, 80968, nil, "Healer", 2, 5, nil, DBM_COMMON_L.HEALER_ICON)
